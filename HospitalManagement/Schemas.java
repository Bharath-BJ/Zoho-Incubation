...
public class Schemas 
{
	...
	public static boolean checkEntry(String name,String mobileNo,String inTime)throws Exception {
		Class.forName("com.mysql.cj.jdbc.Driver");
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost/hospital","root","bharath994420@gmail.com");
		Statement st=con.createStatement();
		ResultSet rs=st.executeQuery("Select Name from PatientDetails where Name='"+name+"' AND MobileNo='"+mobileNo+ "'");
